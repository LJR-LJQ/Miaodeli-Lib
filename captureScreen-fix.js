...
function captureScreen(filePathAbs, scb, fcb) {
	...
	debugger;
	child_process.exec(platformMap[process.platform], {env: process.env}, function(err, stdout, stderr){debugger;
		if(err) {
			console.log(err);
			fcb();
			return;
...
// captureScreen('C:/Users/Jianru/Desktop/out/a.jpg', function() {
// 	console.log('failure');
// }, function() {
// 	console.log('failure');
// })